...
import { makeSonic } from "../entities/snail";
...
export default function game() {
  ...
  const bgPieces = [
    k.add([k.sprite("chemical-bg"), k.pos(0, 0), k.scale(2), k.opacity(50)]),
    k.add([
      k.sprite("chemical-bg"),
      k.pos(bgPieceWidth, 1),
      k.scale(5),
      k.opacity(0.8),
    ]),
  ];
  ...
  const scoreText = k.add([
    k.text("SCORE : 0", { font: "mania", size: 72, fontColor: "black" }),
    k.pos(20, 20),
  ]);
  let score = 0;
